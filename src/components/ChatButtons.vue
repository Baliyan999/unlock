    ...
    >
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div>
            <div class="font-medium text-gray-900">{{ $t('chat.telegram') }}</div>
            <div class="text-sm text-gray-600">{{ $t('chat.telegramDesc') }}</div>
          </div>
        </a>
        ...
        >
          ...
          <div>
            <div class="font-medium text-gray-900">{{ $t('chat.whatsapp') }}</div>
            <div class="text-sm text-gray-600">{{ $t('chat.whatsappDesc') }}</div>
          </div>
        </a>
        
        <!-- Если нет настроенных чатов -->
        <div v-if="!telegramUrl && !whatsappUrl" class="text-center py-4 text-gray-500">
